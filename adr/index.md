...
| ADR-044 | [Three-Layer Team Budget Governance](adr-044-per-member-budget-and-iteration-governance.md) | Accepted | 2026-06-27 |
| ADR-045 | [Prose-showrunner → DAG import adapter](adr-045-prose-showrunner-dag-import-adapter.md) | Accepted | 2026-06-27 |
| ADR-046 | [Human-gate rejection → revision → re-invoke](adr-046-human-gate-rejection-revision-reinvoke.md) | Accepted | 2026-06-27 |
| ADR-047 | [Harness Compiler / Planner (the prose on-ramp)](adr-047-harness-compiler-planner.md) | Accepted | 2026-06-27 |
| ADR-048 | [Three Team Lifecycles (Bounded Run / Standing Team / Seeded Refresh)](adr-048-three-team-lifecycles.md) | Accepted | 2026-06-27 |
| ADR-050 | [Compiled Agents Are Registered Capabilities; `manifest_ref` Is the Registry Id (amends ADR-031 §124; oraclous-backend#695)](adr-050-compiled-agents-are-registered-capabilities.md) | Proposed | 2026-08-04 |

> **ADR-022** is **ported from the legacy `develop` branch @ `84152635de05c105765cfe6b631bb5ba81f2f4aa` (TASK-237)** and kept at its **original legacy number** for traceability to the binding spec. It is the binding ingestion specification for the R3.5 knowledge-graph-service (service #1). The next NEW number is **ADR-051** (ADR-031–050 taken; ADR-050 compiled-agent registration, Proposed 2026-08-04; 022 is the ported legacy ADR). **ADR-049 is RESERVED** for the org-unit hierarchy access decision (oraclous-backend#640), drafted on an unmerged branch and not yet on `main` — do not reuse the number.
...
* **Numbering is monotonic.** ADR-044 is the next number for NEW decisions (ADR-031–043 taken; ADR-043 conductor + Flow-6 consciousness Learn loop, Accepted); numbers are not reused even if an ADR is rejected. (ADR-022 is a **ported legacy ADR** kept at its original number for traceability.)
