...
- [Team-of-Agents Capability Design](../../oraclous-backend/docs/team-of-agents-capability-design.md) — §5 A1 (`members[]`, capability ceiling), B2 (orchestration agent), B4 (A2A invoke), B5 (hand-off), C4 (blackboard), D4 (HITL-as-member)
